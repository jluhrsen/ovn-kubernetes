...
// wired by downstream adapters using container.Engine with their own runner
// instead of using Provider directly. See
// docs/developer-guide/ssh_infra_provider.md.
//
// # Execution model
//
...
// # Composability
//
// The shared container.Engine implements the external-container/network
// surface. Provider wires it to an SSH runner and adds a pluggable NodeExecutor.
//
// # Security
//
